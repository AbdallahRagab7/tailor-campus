<template>
  ...
  <script>
  import navTabtwo from "../../components/liveMeeting/navTabtwo.vue";
  import courseContent from "../../components/courseDetailsComponents/navTabComponents/courseContent.vue";
